...
<body>
    ...
    <main>
        ...
        <div class="container">
            ...
            <h1 class="titulo-servico" style="margin-top:100px;">Solicitar novo Serviço</h1>
                <div class="row row-esqueci-senha" style="justify-content: center; margin-top: 50px">
                    <div class="col-6">
                        <form class="form-entrar needs-validation" novalidate action="entrar.php?link=1">
                            ...
                            <div class="col-md-12 mb-3" style="margin-top: 50px; margin-bottom: 30px;">
                            ...
                            <div class="col-md-12 mb-3" style="margin-top: 50px; margin-bottom: 30px; display:flex; justify-content:space-between;">
