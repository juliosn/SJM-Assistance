        ...
        <div id="carouselExampleFade" class="carousel slide carousel-fade" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <!-- <svg class="img-carrousel bd-placeholder-img bd-placeholder-img-lg d-block w-100" width="800" height="400" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: First slide" preserveAspectRatio="xMidYMid slice" focusable="false"><title>Placeholder</title><rect width="100%" height="100%" fill="#777"></rect><text style="font-size: 55px;" x="45%" y="50%" fill="#555" dy=".3em">First slide</text></svg> -->
                ...
                <div class="carousel-item">
                    <!-- <svg class="img-carrousel bd-placeholder-img bd-placeholder-img-lg d-block w-100" width="800" height="400" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: First slide" preserveAspectRatio="xMidYMid slice" focusable="false"><title>Placeholder</title><rect width="100%" height="100%" fill="#777"></rect><text style="font-size: 55px;" x="40%" y="50%" fill="#555" dy=".3em">Second slide</text></svg> -->
                ...
                <div class="carousel-item">
                    <!-- <svg class="img-carrousel bd-placeholder-img bd-placeholder-img-lg d-block w-100" width="800" height="400" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: First slide" preserveAspectRatio="xMidYMid slice" focusable="false"><title>Placeholder</title><rect width="100%" height="100%" fill="#777"></rect><text style="font-size: 55px;" x="40%" y="50%" fill="#555" dy=".3em">Third slide</text></svg> -->
            ...
            <div class="marcas-parceiras">
                ...
                <div class="row">
                    <div class="col marca bd-highlight">
                        <h1>HP</h1>
                        <p class="text-marcas-parceiras">Se hoje é o dia das crianças... Ontem eu disse: o dia da criança é o dia da mãe, dos pais, das professoras, mas também é o dia dos animais, sempre que você olha uma criança, há sempre uma figura oculta, que é um cachorro atrás. O que é algo muito importante!</p>
                        <a href="#" class="btn btn-saiba-mais">Saiba mais</a>
                    </div>
                    <div class="col marca">
                        <h1>Acer</h1>
                        <p class="text-marcas-parceiras">No meu xinélo da humildade eu gostaria muito de ver o Neymar e o Ganso. Por que eu acho que.... 11 entre 10 brasileiros gostariam. Você veja, eu já vi, parei de ver. Voltei a ver, e acho que o Neymar e o Ganso têm essa capacidade de fazer a gente olhar.</p>
                        <a href="#" class="btn btn-saiba-mais">Saiba mais</a>
                    </div>
                    <div class="col marca">
                        <h1>Asus</h1>
                        <p class="text-marcas-parceiras">A única área que eu acho, que vai exigir muita atenção nossa, e aí eu já aventei a hipótese de até criar um ministério. É na área de... Na área... Eu diria assim, como uma espécie de analogia com o que acontece na área agrícola.<br><br></p>
                        <a href="#" class="btn btn-saiba-mais">Saiba mais</a>
                    </div>
                    <div class="col marca">
                        <h1>Positivo</h1>
                        <p class="text-marcas-parceiras">Primeiro eu queria cumprimentar os internautas. -Oi Internautas! Depois dizer que o meio ambiente é sem dúvida nenhuma uma ameaça ao desenvolvimento sustentável. E isso significa que é uma ameaça pro futuro do nosso planeta e dos nossos países. O desemprego beira 20%, ou seja, 1 em cada 4 portugueses.</p>
                        <a href="#" class="btn btn-saiba-mais">Saiba mais</a>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row row-links">
                <div class="col-3 col-img-footer">
                    <img src="img/SJM.png" class="img-footer">
                </div>
            ...
            <div class="container" style="margin-top: 25px;">
                <div class="row" style="justify-content: center!important;">
                    ...
                    <div class="col div-link-icons">
                        <a class="img-link-footer" href="http://" target="_blank"><!-- Facebook -->
                            <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-facebook" viewBox="0 0 16 16">
                                <path d="M16 8.049c0-4.446-3.582-8.05-8-8.05C3.58 0-.002 3.603-.002 8.05c0 4.017 2.926 7.347 6.75 7.951v-5.625h-2.03V8.05H6.75V6.275c0-2.017 1.195-3.131 3.022-3.131.876 0 1.791.157 1.791.157v1.98h-1.009c-.993 0-1.303.621-1.303 1.258v1.51h2.218l-.354 2.326H9.25V16c3.824-.604 6.75-3.934 6.75-7.951z"/>
                            </svg>
                        </a>
                        <a class="img-link-footer" href="http://" target="_blank"><!-- Instagram -->
                        ...
                        <a class="img-link-footer" href="http://" target="_blank"><!-- Contato -->
                        ...
                        <a class="img-link-footer" href="http://" target="_blank"><!-- Email -->
                        ...
                        <a class="img-link-footer" href="http://" target="_blank"><!-- Linkedin -->
                        ...
                        <a class="img-link-footer" href="http://" target="_blank"><!--YouTube -->
