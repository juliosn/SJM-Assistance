        ...
        <div class="container">
            <div class="marcas-parceiras">
                ...
                <div class="row">
                    ...
                    <div class="col marca">
                        <h1>Samsung</h1>
                        <p>A única área que eu acho, que vai exigir muita atenção nossa, e aí eu já aventei a hipótese de até criar um ministério. É na área de... Na área... Eu diria assim, como uma espécie de analogia com o que acontece na área agrícola.<br><br></p>
                        <a href="#" class="btn btn-saiba-mais">Saiba mais</a>
                    </div>
                    <div class="col marca">
                        <h1>Samsung</h1>
        ...
        <div class="container">
            <div class="row row-links">
                ...
                <div class="col-2 col-link link-centro">
                    ...
                    <div class="row">
                        <div class="col col-link-footer"><a class="link-footer" href="#">Júia da Silva</a></div>
                    </div>
                    <div class="row">
                ...
                <div class="col-2 col-link link-right">
                    <div class="row">
            ...
            <div class="container" style="margin-top: 25px;">
                <div class="row" style="justify-content: center!important;">
                    <div class="col" style="text-align: left;">
                            <p class="copyright">© SJM Assistencia. 2022</p>
                    </div>
