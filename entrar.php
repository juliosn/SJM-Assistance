<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $cadastrar->setEmailLogin($_POST['txtEmailEntrar']);
        $cadastrar->setSenhaLogin($_POST['txtSenhaEntrar']);
        $result = $cadastrar->logar(); 
    }
?>
<!DOCTYPE html>
<html lang="pt-br">
           ...
           <?php } ?>
            ...
            <?php } }else{ ?>
                ...
                <div class="row row-entrar" style="align-items: center;">
                    ...
                    <div class="col">
                        <form class="form-entrar needs-validation" method="post" novalidate action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
